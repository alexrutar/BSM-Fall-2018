...
\begin{proof}[Mycielski's Construction]
    ...
    \begin{align*}
        ...
        E(M_{k+1}) &:= E(M_k)\cup\left\{\{u_i,u_j\}:\{v_i,v_j\}\in E(M_k)\}\cup\left\{\{z,u_i\}:i=1,\ldots,n=|V(M_k)|\right\}
    \end{align*}
...
\begin{proof}[Vizing]
    ...
    \begin{center}
        \begin{tikzpicture}[scale=2]
            \node[vtx] (a) at (0,0){};
            \node[vtx,label=above right:{$h(y)$}] (b) at (0:1cm){};
            \node[vtx,label=right:{$h(y_1)$}] (c) at (330:1cm){};
            \node[vtx,label=below right:{$h(y_2)$}] (d) at (300:1cm){};
            \node[vtx,label=below:{$y_3$}] (e) at (270:1cm){};
            \draw[thick] (a) -- (b);
            \draw[thick] (a) -- node[above right]{$h(y)$} (c);
            \draw[thick] (a) -- node[above right]{$h(y_1)$} (d);
        \end{tikzpicture}
    \end{center}
